...
#define T1 2.2 //Extremo inferior del intervalo de temperaturas
#define T2 2.4 //Extremo superior del intervalo de temperaturas
#define nT 3 //Número de valores de temperatura que se van a considerar en el intervalo [T1,T2]
