...
#define T1 2.27 //Extremo inferior del intervalo de temperaturas
#define T2 2.29 //Extremo superior del intervalo de temperaturas
...
//Función corr: devuelve la correlación
