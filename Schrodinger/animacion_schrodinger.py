...
# Parámetros
# ========================================
file_in = "schrodinger_data.dat" # Nombre del fichero de datos: "schrodinger_data.dat", "norma.txt"
file_out = "schrodinger-lambda=5" # Nombre del fichero de salida (sin extensión)
